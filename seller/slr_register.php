...
$storeName = $address = $city = $province = $postalCode = $businessEmail = $contactNumber = $taxId = $bankAccountNumber = $bankName = $transitNumber = $institutionNumber = "";
$storeNameErr = $addressErr = $cityErr = $provinceErr = $postalCodeErr = $businessEmailErr = $contactNumberErr = $taxIdErr = $bankAccountNumberErr = $bankNameErr = $transitNumberErr = $institutionNumberErr = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($bankName)) {
        $bankNameErr = "Bank account number is required";
    }
    ...
    if (empty($storeNameErr) && empty($addressErr) && empty($cityErr) && empty($provinceErr) && empty($postalCodeErr) && empty($businessEmailErr) && empty($contactNumberErr) && empty($taxIdErr) && empty($bankAccountNumberErr) && empty($bankNameErr) && empty($transitNumberErr) && empty($institutionNumberErr)) {
        // Prepare and execute SQL INSERT statement
        $sql = "INSERT INTO sellers (store_name, address, city, province, postal_code, business_email, contact_number, tax_id, bank_account_number, bank_name, transit_number, institution_number) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssssssssss", $storeName, $address, $city, $province, $postalCode, $businessEmail, $contactNumber, $taxId, $bankAccountNumber, $bankName, $transitNumber, $institutionNumber);
        if ($stmt->execute()) {
                                    ...
                                    <form class="row g-3" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <span class="text-danger">
                                                <?php echo $storeNameErr; ?>
                                            </span>
                                        </div>

                                        <div class="col-12">
                                            <label for="address" class="form-label">Unit/Appt. & Street Name:</label>
                                            <div class="input-group">
                                            <span class="input-group-text" id="inputGroupPrepend"><i class='bx bx-building'></i></span>
                                                <input id="address" class="form-control" name="address" value="<?php echo $address; ?>">
                                            </div>
                                            <span class="text-danger">
                                                <?php echo $addressErr; ?>
                                            </span>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group">
                                            <span class="input-group-text" id="inputGroupPrepend"><i class='bx bx-location-plus'></i></span>
                                                <input type="text" id="postalCode" class="form-control" name="postalCode" value="<?php echo $postalCode; ?>">
                                            </div>
                                            <span class="text-danger">
                                                <?php echo $postalCodeErr; ?>
                                            </span>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <label for="taxId" class="form-label">Tax ID (BN):</label>
                                            <div class="input-group">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                            <span class="input-group-text" id="inputGroupPrepend"><i class="ri-bank-card-line"></i></span>
                                                <input type="text" id="transitNumber" class="form-control" name="transitNumber" value="<?php echo $transitNumber; ?>">
                                            </div>
                                            <span class="text-danger">
                                                <?php echo $transitNumberErr; ?>
                                            </span>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                            <span class="input-group-text" id="inputGroupPrepend"><i class="ri-pass-valid-line"></i></span>
                                                <input type="text" id="institutionNumber" class="form-control" name="institutionNumber" value="<?php echo $institutionNumber; ?>">
                                            </div>
                                            <span class="text-danger">
                                                <?php echo $institutionNumberErr; ?>
                                            </span>
                                        </div>
