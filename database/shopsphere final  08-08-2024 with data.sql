...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2024 at 06:22 AM
...
(3, 'Final testing announcement', 'Testing announcement', '2024-08-08 01:57:32', '2024-08-08 01:57:32');
...
(13, 'Footwear', 7.00, '2024-08-08 01:56:31', '2024-08-08 01:56:31');
...
INSERT INTO `contact_messages` (`id`, `user_id`, `full_name`, `email`, `message`, `created_at`) VALUES
(1, NULL, 'New customer', 'new@customer.com', 'NEW CUSTOMER MESSAGE', '2024-08-07 21:01:54'),
(3, 2, 'Test User', 'test@user.com', 'HELLOW FROM LOGGED IN USER', '2024-08-07 21:04:49');
...
(5, 4, 'New Announcement: Final testing announcement', 0, '2024-08-08 01:57:33', 'announcement'),
(6, 5, 'New Announcement: Final testing announcement', 0, '2024-08-08 01:57:33', 'announcement'),
(7, 6, 'New Announcement: Final testing announcement', 0, '2024-08-08 01:57:33', 'announcement'),
(8, 7, 'You have received a new order for Men\'s Slip on Fashion Sneakers Casual for 1.', 0, '2024-08-08 03:11:42', 'order');
...
(14, 5, 43.71, 'Delivered', '2024-08-08 03:11:20', '2024-08-08 03:58:20', '72 Massey Ave', 'Kitchener', 'ON', 'N2C 1M3', '');
...
(39, 7, 13, 'Men\'s Slip on Fashion Sneakers Casual', 'Lightweight breathable knit-mesh fabric upper\r\nEasy slip-on design with dual side goring\r\nRound toe with sturdy reinforcement\r\nFlexible EVA traction outsole\r\nSoft fabric lining, removable EVA memory foam insole', 32.00, 22.00, 12.00, 0.70, '2024-08-08 02:20:37', '2024-08-08 02:26:29'),
(40, 7, 13, 'Womens Orthotic Slides', 'Womens Orthotic Sandals feature classic double Adjustable Straps design with buckle metal loops, can better adjust the Pillow Slides to fit your feet.', 25.70, 10.10, 7.19, 0.23, '2024-08-08 02:34:39', '2024-08-08 02:34:39');
...
(99, 39, 10, 24, 50, 47.00, 'shoe-1.jpg'),
(100, 39, 10, 26, 50, 47.00, 'shoe-1.jpg'),
(101, 39, 10, 28, 50, 47.00, 'shoe-1.jpg'),
(102, 39, 8, 37, 50, 47.00, 'shoe-2.jpg'),
(103, 39, 8, 39, 49, 47.00, 'shoe-2.jpg'),
(104, 39, 8, 41, 50, 47.00, 'shoe-2.jpg'),
(105, 40, 22, 23, 50, 33.00, 'slide-1.jpg'),
(106, 40, 22, 19, 50, 33.00, 'slide-1.jpg'),
(107, 40, 22, 18, 50, 33.00, 'slide-1.jpg'),
(108, 40, 7, 31, 50, 33.00, 'slide-2.jpg'),
(109, 40, 7, 33, 50, 33.00, 'slide-2.jpg');
...
(4, 'Test store', '123 Abc Street 2', 'Abc City 2', 'ON', 'N2E 3M3', 'test@test.com', '$2y$10$zbdVc3K2MUozoZBCz0UIn.I0IFoaOw7hQ3CkYjtMuLQ/x2wTlUUem', '1234567891', '123456789', '1234567', 'CIBC', '12345', '123', '2024-06-28 02:56:20', '2024-08-07 18:58:43', NULL, NULL),
...
(7, 'Woot', '275 Blockline Rd', 'Kitchener', 'ON', 'N2C 1M4', 'woot@gmail.com', '$2y$10$.c8dcl0VoVgUpvDd/hqBb.zDXhSHdAIl0wvbI7kf3fqjd/KDpMYhK', '1234567891', '123456789', '1234567', 'RBC', '12345', '123', '2024-08-08 02:03:18', '2024-08-08 04:02:59', NULL, NULL);
...
(11, 14, 43.71, 'Completed', '8GE544745H445383V', NULL, '2024-08-08 03:11:42', '2024-08-08 03:11:42');
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `mobile_number`, `password`, `email`, `created_at`, `updated_at`, `reset_token`, `token_expiry`) VALUES
(1, 'Krunal', 'Chhabhaya', '5197817326', '$2y$10$7I15W6Y9R2TVxfaupDiBru1hMezEbmkcnm1n1SQY.1bzpCa0hYKhy', 'krunalchhabhaya7803@gmail.com', '2024-06-29 21:14:06', '2024-06-29 21:14:06', NULL, NULL),
(2, 'Test', 'User', '1234567891', '$2y$10$M2ipLuVy6hkTkFbT.F58geFz4jioS3qtxnJ25QRKruCTZWRFSTS62', 'test@user.com', '2024-07-02 18:56:10', '2024-08-07 19:54:51', NULL, NULL),
(5, 'Deep', 'Vekariya', '1234567890', '$2y$10$FB4ahjjL7e5YK.mAqldh.eGrIZKsxUvZ9ATkOWs4ZMXKxS3JEyRY6', 'deep@gmail.com', '2024-08-08 03:10:10', '2024-08-08 03:14:25', NULL, NULL);
...
--
ALTER TABLE `product_variants`
  MODIFY `variant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
